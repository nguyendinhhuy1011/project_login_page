...
class _RatingPageState extends State<RatingPage> {
  ...
  void initState() {
    listRating.addAll([
      ...
      RatingModel(
        ...
        imagePost: ['https://kiemtientuweb.com/ckfinder/userfiles/images/anh-gai-xinh/anh-gai-xinh-26.jpg']
      ),
    ]);
    super.initState();
  }
  ...
  Widget buildReview(RatingModel rating) {
    return Container(
        ...
        children: [
              ...
              Expanded(
                child: Column(
                  ...
                  children: [
                    ...
                    Text(rating.datePost),
                  ],
                ),
              ),
              Icon(Icons.star,color: Colors.amber,),
              Text(' ${rating.ratingStar.toString()} ',style: TextStyle(fontWeight: FontWeight.w500),),
            ],
          ),
          SizedBox(
            height: 16,
          ...
          Container(
            ...
            child: GridView.builder(
                itemCount: rating.imagePost!.length,
                physics: NeverScrollableScrollPhysics(),
                gridDelegate: SliverGridDelegateWithFixedCrossAxisCount(
                  crossAxisCount: rating.imagePost!.length==1?1:
                  rating.imagePost!.length==2?2:3,
                  crossAxisSpacing: 4,
                  mainAxisSpacing: 4,
                ),
                itemBuilder: (BuildContext context, int index){
                  return Image.network(rating.imagePost![index] );
                }
            ),
          ),
        ],
